...
export default function GallerySection() {
  ...
  return (
    <section className="bg-[#050505] text-white py-24 px-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
         <div className="text-center mb-16">
           <h2 className="text-3xl tracking-[0.1em] text-white/90 font-light uppercase">Visuals</h2>
         </div>
