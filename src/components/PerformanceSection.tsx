...
export default function PerformanceSection() {
  return (
    <section className="min-h-screen bg-black text-white py-16 md:py-24 px-4 md:px-8 relative overflow-hidden flex flex-col justify-center border-t border-white/10">
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-white/60 text-base md:text-lg max-w-xl font-light tracking-wide leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 border-t border-white/20 pt-8 md:pt-12">
          {/* Stat 1 */}
          <motion.div 
